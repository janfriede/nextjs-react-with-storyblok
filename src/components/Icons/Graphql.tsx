  ...
  ({
    ...
    return (
      ...
      >
        ...
        />
        <circle cx="24.5" cy="5.5" r="3.5" fill={fill} />
        <circle cx="24.5" cy="43.5" r="3.5" fill={fill} />
        <circle cx="8.5" cy="33.5" r="3.5" fill={fill} />
        <circle cx="40.5" cy="33.5" r="3.5" fill={fill} />
        <circle cx="8.5" cy="15.5" r="3.5" fill={fill} />
        <circle cx="40.5" cy="15.5" r="3.5" fill={fill} />
        <path
          fill={fill}
